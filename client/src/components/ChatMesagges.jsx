...
const ChatMessages = () => {
  ...
  return (
    <div className="w-[500px] shadow-md bg-white p-4 rounded-lg">
      <h1 className="w-full text-center text-xl font-semibold text-gray-800">
        Chatting App
      </h1>
      <div className="w-full border mt-4 mb-4 h-[450px] rounded-md p-3 overflow-y-auto flex flex-col-reverse relative">
        {messages
          .slice()
          .reverse()
          .map((message, index) => (
